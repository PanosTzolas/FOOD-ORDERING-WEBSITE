...
?>
    ...
    return preg_match("/(android|avantgo|blackberry|bolt|boost|cricket|docomo|fone|hiptop|mini|mobi|palm|phone|pie|tablet|up\.browser|up\.link|webos|wos)/i", $_SERVER["HTTP_USER_AGENT"]);
							...
							<div class="body">
									...
									<br>
									<form class="form-wrap text-center" action="login.php" method="POST">
										<input type="text" class="form-control" name="userid" placeholder="Username/Email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Name'" >
							...
							?>
									...
									<form class="form-wrap text-center" action="register.php" method="POST">
										<input type="text" class="form-control" name="userid" placeholder="Username/Email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Name'" >
										<input type="text" class="form-control" name="phone" placeholder="Phone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone'" >
										<input type="password" class="form-control" name="pswrd" placeholder="password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'password'" >
										<button class="primary-btn text-uppercase mt-20">Register</button>
									</form>
							<?php
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							...
							<a href="blog-single.php"><h4>Cooking Perfect Fried Rice
							in minutes</h4></a>
							<p>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							...
							<p class="date">10 Jan 2018</p>
							<a href="blog-single.php"><h4>Secret of making Heart
							Shaped eggs</h4></a>
							<p>
								inappropriate behavior ipsum dolor sit amet, consectetur.
							</p>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							...
							<p class="date">10 Jan 2018</p>
							<a href="blog-single.php"><h4>How to check steak if
						...
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							...
							<p class="date">10 Jan 2018</p>
							<a href="blog-single.php"><h4>Seaseme and black seed
